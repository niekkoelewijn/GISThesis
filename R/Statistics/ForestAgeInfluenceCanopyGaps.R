...
# age classes on canopy gap statistics

# Create 5 age classes and add new attribute to gaps 
new_gaps_influence_age <- new_gaps_complete %>% 
...
levels(new_gaps_influence_age$age_class) <- c("0-40", "40-80", "80-120",
                                              "120-160", "160-200")
...
ggbetweenstats(
  ...
  bf.message = FALSE,
  title = "Gap area per age class",
  xlab = "age class",
  ylab = "area "
)

§# Boxplot of canopy gap shape_area
ggplot(new_gaps_influence_age, 
       aes(age_class, shape_area, fill = age_class)) +
  geom_boxplot() +
...
ggplot(new_gaps_influence_age, 
       aes(age_class, shape_perimeter, fill = age_class)) +
  geom_boxplot() +
...
ggplot(new_gaps_influence_age, 
       aes(age_class, dist_nn, fill = age_class)) +
  geom_boxplot() +
...
ggplot(new_gaps_influence_age, 
       aes(age_class, buffer5m_overlap_relative, fill = age_class)) +
  geom_boxplot() +
...
ggplot(new_gaps_influence_age, 
       aes(age_class, buffer10m_overlap_relative, fill = age_class)) +
  geom_boxplot() +
...
ggplot(new_gaps_influence_age, 
       aes(age_class, mean_CHM3, fill = age_class)) +
  geom_boxplot() +
...
ggplot(new_gaps_influence_age, 
       aes(age_class, mean_CHM4, fill = age_class)) +
  geom_boxplot() +
  stat_compare_means(label.y = 48,
                     symnum.args = symnum.args) +
  scale_fill_grey(start = 0.3) +
...
ggplot(new_gaps_influence_age, 
       aes(age_class, mean_CHMdiv, fill = age_class)) +
  geom_boxplot() +
...
ggplot(new_gaps_influence_age, 
       aes(age_class, fraq_NGCM, fill = age_class)) +
  geom_boxplot() +
...
ggplot(new_gaps_influence_age, 
       aes(age_class, fraq_NGBM, fill = age_class)) +
  geom_boxplot() +
  stat_compare_means(label.y = 1.40,
                     symnum.args = symnum.args) +
  scale_fill_grey(start = 0.3) +
...
mshape_area <- new_gaps_influence_age %>% 
  sf::st_drop_geometry() %>% 
  group_by(age_class) %>% 
  summarise(
...
mshape_area %>% 
  ggplot(aes(age_class, mean_shape_area)) +
...
mshape_perimeter <- new_gaps_influence_age %>% 
  sf::st_drop_geometry() %>% 
  group_by(age_class) %>% 
  summarise(
...
mshape_perimeter %>% 
  ggplot(aes(age_class, mean_shape_perimeter)) +
  geom_col(aes(fill = age_class), color = "black", width = 0.85) +
...
mdist_nn <- new_gaps_influence_age %>% 
  sf::st_drop_geometry() %>% 
  group_by(age_class) %>% 
  summarise(
...
mdist_nn %>% 
  ggplot(aes(age_class, mean_dist_nn)) +
  geom_col(aes(fill = age_class), color = "black", width = 0.85) +
...
mbuffer5m_overlap_relative <- new_gaps_influence_age %>% 
  sf::st_drop_geometry() %>% 
  group_by(age_class) %>% 
  summarise(
...
mbuffer5m_overlap_relative %>% 
  ggplot(aes(age_class, mean_buffer5m_overlap_relative)) +
  geom_col(aes(fill = age_class), color = "black", width = 0.85) +
...
mbuffer10m_overlap_relative <- new_gaps_influence_age %>% 
  sf::st_drop_geometry() %>% 
  group_by(age_class) %>% 
  summarise(
...
mbuffer10m_overlap_relative %>% 
  ggplot(aes(age_class, mean_buffer10m_overlap_relative)) +
  geom_col(aes(fill = age_class), color = "black", width = 0.85) +
...
mmean_CHM3 <- new_gaps_influence_age %>% 
  sf::st_drop_geometry() %>% 
  group_by(age_class) %>% 
  summarise(
...
mmean_CHM3 %>% 
  ggplot(aes(age_class, mean_mean_CHM3)) +
  geom_col(aes(fill = age_class), color = "black", width = 0.85) +
...
mmean_CHM4 <- new_gaps_influence_age %>% 
  sf::st_drop_geometry() %>% 
  group_by(age_class) %>% 
  summarise(
...
mmean_CHM4 %>% 
  ggplot(aes(age_class, mean_mean_CHM4)) +
  geom_col(aes(fill = age_class), color = "black", width = 0.85) +
...
mmean_CHMdiv <- new_gaps_influence_age %>% 
  sf::st_drop_geometry() %>% 
  group_by(age_class) %>% 
  summarise(
...
mmean_CHMdiv %>% 
  ggplot(aes(age_class, mean_mean_CHMdiv)) +
  geom_col(aes(fill = age_class), color = "black", width = 0.85) +
...
mfraq_NGCM <- new_gaps_influence_age %>% 
  sf::st_drop_geometry() %>% 
  group_by(age_class) %>% 
  summarise(
...
mfraq_NGCM %>% 
  ggplot(aes(age_class, mean_fraq_NGCM)) +
  geom_col(aes(fill = age_class), color = "black", width = 0.85) +
...
mfraq_NGBM <- new_gaps_influence_age %>% 
  sf::st_drop_geometry() %>% 
  group_by(age_class) %>% 
  summarise(
...
mfraq_NGBM %>% 
  ggplot(aes(age_class, mean_fraq_NGBM)) +
  geom_col(aes(fill = age_class), color = "black", width = 0.85) +
