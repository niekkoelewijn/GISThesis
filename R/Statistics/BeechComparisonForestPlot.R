...
# management classes on forest plot level, for the tree species beech only.
...
# Select the forest plots with as dominant tree species beech
forest_metrics_beech <- forest_metrics_raster_metrics %>% 
...
ggplot(forest_metrics_beech, 
  ...
  ggtitle("Forest plot mean fraction in gap, beech")+
...
ggplot(forest_metrics_beech, 
  ...
  theme_minimal() +
  ylab("gap density") +
  ggtitle("Forest plot mean gap density, beech")+
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 12,
...
ggplot(forest_metrics_beech, 
  ...
  ggtitle("Forest plot mean dispersion index, beech")+
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 12,
...
ggplot(forest_metrics_beech, 
  ...
  theme_minimal() +
  ylab("canopy edge") +
  ggtitle("Forest plot mean canopy edge, beech")+
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 12,
...
ggplot(forest_metrics_beech, 
  ...
  ylim(0,45) +
  ylab("height [m]") +
  ggtitle("Forest plot mean height in CHM3, beech")+
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 12,
...
ggplot(forest_metrics_beech, 
  ...
  ylim(0,45) +
  ylab("height [m]") +
  ggtitle("Forest plot mean height in CHM4, beech")+
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 12,
...
ggplot(forest_metrics_beech, 
  ...
  theme_minimal() +
  ylab("height [m]") +
  ggtitle("Forest plot mean difference in height between CHM3 & CHM4, beech")+
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
...
ggplot(forest_metrics_beech, 
  ...
  ggtitle("Forest plot mean gini coefficient CHM4, beech")+
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
...
ggplot(forest_metrics_beech, 
  ...
  theme_minimal() +
  ylab("fraction") +
  ggtitle("Forest plot mean fraction no gap detected, beech")+
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 11,
...
ggplot(forest_metrics_beech, 
  ...
  theme_minimal() +
  ylab("fraction") +
  ggtitle("Forest plot mean fraction disappeared gap, beech")+
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 11,
...
ggplot(forest_metrics_beech, 
  ...
  theme_minimal() +
  ylab("fraction") +
  ggtitle("Forest plot mean fraction remaining gap, beech")+
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 11,
...
ggplot(forest_metrics_beech, 
  ...
  theme_minimal() +
  ylab("fraction") +
  ggtitle("Forest plot mean fraction new gap CHM-subtraction method, beech")+
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 9,
...
ggplot(forest_metrics_beech, 
  ...
  theme_minimal() +
  ylab("fraction") +
  ggtitle("Forest plot mean fraction disappeared gaps due to vertical closure, beech")+
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 9,
...
ggplot(forest_metrics_beech, 
  ...
  theme_minimal() +
  ylab("age [y]") +
  ggtitle("Forest plot mean age, beech")+
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 12,
...
mForestPlot_PIG <- forest_metrics_beech %>% 
  sf::st_drop_geometry() %>% 
...
mForestPlot_PIG %>% 
  ...
  labs(
    y = "fraction in gap",
    title = "Forest plot mean fraction in gap, beech") +
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 12,
...
mForestPlot_GD <- forest_metrics_beech %>% 
  sf::st_drop_geometry() %>% 
  group_by(managed_class) %>% 
  summarise(
...
mForestPlot_GD %>% 
  ...
  labs(
    y = "gap density",
    title = "Forest plot mean gap density, beech") +
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 12,
...
mForestPlot_DI <- forest_metrics_beech %>% 
...
mForestPlot_DI %>% 
  ...
  labs(
    y = "dispersion index",
    title = "Forest plot mean dispersion index, beech") +
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 12,
...
mForestPlot_CE <- forest_metrics_beech %>% 
  tidyr::replace_na(list(ForestPlot_DI = 0, ForestPlot_CE = 0)) %>% 
  sf::st_drop_geometry() %>% 
  group_by(managed_class) %>% 
  summarise(
...
mForestPlot_CE %>% 
  ...
  labs(
    y = "canopy edge",
    title = "Forest plot mean canopy edge, beech") +
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 12,
...
mForestPlot_mean_CHM3 <- forest_metrics_beech %>% 
  sf::st_drop_geometry() %>% 
  group_by(managed_class) %>% 
  summarise(
...
mForestPlot_mean_CHM3 %>% 
  ...
  labs(
    y = "height [m]",
    title = "Forest plot mean height in CHM3, beech") +
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 12,
...
mForestPlot_mean_CHM4 <- forest_metrics_beech %>% 
  sf::st_drop_geometry() %>% 
  group_by(managed_class) %>% 
  summarise(
...
mForestPlot_mean_CHM4 %>% 
  ...
  labs(
    y = "height [m]",
    title = "Forest plot mean height in CHM4, beech") +
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 12,
...
mForestPlot_mean_CHMdiv <- forest_metrics_beech %>% 
  sf::st_drop_geometry() %>% 
  group_by(managed_class) %>% 
  summarise(
...
mForestPlot_mean_CHMdiv %>% 
  ...
  labs(
    y = "height [m]",
    title = "Forest plot mean difference in height in CHM3 & CHM4, beech") +
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 11,
...
mForestPlot_gini_CHM4 <- forest_metrics_beech %>% 
  sf::st_drop_geometry() %>% 
  group_by(managed_class) %>% 
  summarise(
...
mForestPlot_gini_CHM4 %>% 
  ...
  labs(
    y = "Gini coefficient",
    title = "Forest plot mean Gini coefficient  CHM4, beech") +
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 12,
...
mForestPlot_fraq_NoG <- forest_metrics_beech %>% 
  sf::st_drop_geometry() %>% 
  group_by(managed_class) %>% 
  summarise(
...
mForestPlot_fraq_NoG %>% 
  ...
  labs(
    y = "fraction",
    title = "Forest plot mean fraction no gap detected, beech") +
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 12,
...
mForestPlot_fraq_DG <- forest_metrics_beech %>% 
  sf::st_drop_geometry() %>% 
  group_by(managed_class) %>% 
  summarise(
...
mForestPlot_fraq_DG %>% 
  ...
  labs(
    y = "fraction",
    title = "Forest plot mean fraction disappeared gap, beech") +
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 12,
...
mForestPlot_fraq_RG <- forest_metrics_beech %>% 
  sf::st_drop_geometry() %>% 
  group_by(managed_class) %>% 
  summarise(
...
mForestPlot_fraq_RG %>% 
  ...
  labs(
    y = "fraction",
    title = "Forest plot mean fraction remaining gap, beech") +
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 12,
...
mForestPlot_fraq_NGCM <- forest_metrics_beech %>% 
  sf::st_drop_geometry() %>% 
  group_by(managed_class) %>% 
  summarise(
...
mForestPlot_fraq_NGCM %>% 
  ...
  labs(
    y = "fraction",
    title = "Forest plot mean fraction new gap CHM-subtraction method, beech") +
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 9,
...
mForestPlot_fraq_NGBM <- forest_metrics_beech %>% 
  sf::st_drop_geometry() %>% 
  group_by(managed_class) %>% 
  summarise(
...
mForestPlot_fraq_NGBM %>% 
  ...
  labs(
    y = "fraction",
    title = "Forest plot mean fraction new gap both methods, beech") +
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 11,
...
mForestPlot_fraq_VC <- forest_metrics_beech %>% 
  sf::st_drop_geometry() %>% 
  group_by(managed_class) %>% 
  summarise(
...
mForestPlot_fraq_VC %>% 
  ...
  labs(
    y = "fraction",
    title = "Forest plot mean fraction disappeared gaps due to vertical closure, beech") +
  theme(legend.position="none",
        axis.title.x=element_blank(),
        legend.title = element_blank(),
        plot.title = element_text(size = 9,
...
mForestPlot_age <- forest_metrics_beech %>% 
  sf::st_drop_geometry() %>% 
  group_by(managed_class) %>% 
  summarise(
