...
new_gaps_complete <- new_gaps_complete %>% 
  dplyr::mutate(managed_class = forcats::as_factor(managed_class)) %>% 
  dplyr::mutate(managed_class = forcats::fct_relevel(managed_class, "managed"))
...
dunnTest(shape_area ~ managed_class,
         data = new_gaps_complete,
         method = "bonferroni")
...
dunnTest(shape_perimeter ~ managed_class,
         data = new_gaps_complete,
         method = "bonferroni")
...
dunnTest(dist_nn ~ managed_class,
         data = new_gaps_complete,
         method = "bonferroni")
...
dunnTest(buffer5m_overlap_relative ~ managed_class,
         data = new_gaps_complete,
         method = "bonferroni")
...
dunnTest(buffer10m_overlap_relative ~ managed_class,
         data = new_gaps_complete,
         method = "bonferroni")
...
dunnTest(mean_CHM3 ~ managed_class,
         data = new_gaps_complete,
         method = "bonferroni")
...
dunnTest(mean_CHM4 ~ managed_class,
         data = new_gaps_complete,
         method = "bonferroni")
...
dunnTest(mean_CHMdiv ~ managed_class,
         data = new_gaps_complete,
         method = "bonferroni")
...
dunnTest(fraq_NGCM ~ managed_class,
         data = new_gaps_complete,
         method = "bonferroni")
...
dunnTest(fraq_NGBM ~ managed_class,
         data = new_gaps_complete,
         method = "bonferroni")
